...
if (have_posts()) : 
    ...
    // Get overview (Ãœberblick) - prioritize meta field (from editor) over database table
    ...
    if ($eval_criteria_meta && !empty(trim($eval_criteria_meta))) {
        ...
        $sections = [
            ...
            'relevance' => ['pattern' => '/(?:<strong>|\\*\\*)Relevanz\s*fÃ¼r\s*die\s*MobilitÃ¤tswende:(?:<\/strong>|\\*\\*)(?:<br>|<br\/>|\s)*(.+?)(?=<strong>|\\*\\*|$)/is', 'label' => 'Relevanz fÃ¼r die MobilitÃ¤tswende'],
        ...
        $criteria_mapping = [
            ...
            'relevanz_mobilitaetswende' => [
                'key' => 'relevance',
                'label' => 'Relevanz fÃ¼r die MobilitÃ¤tswende',
                ...
                <div class="mt-hero-info">
                    ...
                    <?php if ($position || $organization) : ?>
                        <div class="mt-hero-title">
                            ...
                            <?php endif; ?>
                            <?php if ($position && $organization) : ?>
                                <span class="mt-separator">â€¢</span>
                            <?php endif; ?>
                            <?php if ($organization) : ?>
