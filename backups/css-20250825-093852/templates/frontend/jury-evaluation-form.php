...
<div class="mt-evaluation-page">
        ...
        <div class="mt-candidate-profile">
            ...
            <div class="mt-candidate-details">
                ...
                if (!empty($full_description)) : ?>
                    <div class="mt-candidate-card__description-section">
                        <h3 class="mt-candidate-card__section-title"><?php _e('Description', 'mobility-trailblazers'); ?></h3>
                ...
                if (!empty(trim($bio_content))) : ?>
                    <div class="mt-candidate-card__bio-section">
                        <h3 class="mt-candidate-card__section-title"><?php _e('Description', 'mobility-trailblazers'); ?></h3>
                        <div class="mt-candidate-card__description">
                            <?php 
                            ...
                            if (strlen($bio_display) > 500) {
                                echo '<p class="mt-candidate-card__description-text">' . wp_trim_words($bio_display, 80, '...') . '</p>';
                            } else {
                                echo '<p class="mt-candidate-card__description-text">' . $bio_display . '</p>'; 
                            }
                            ?>
                        </div>
                    </div>
    ...
    <div class="mt-criteria-info-section">
        ...
        <div class="mt-criteria-info-grid">
            ...
            <div class="mt-evaluation-form__criterion mt-evaluation-form__criterion--courage">
                <div class="mt-evaluation-form__criterion-header">
                    <span class="mt-evaluation-form__criterion-icon dashicons dashicons-superhero"></span>
            ...
            <div class="mt-evaluation-form__criterion mt-evaluation-form__criterion--innovation">
                <div class="mt-evaluation-form__criterion-header">
                    <span class="mt-evaluation-form__criterion-icon dashicons dashicons-lightbulb"></span>
            ...
            <div class="mt-evaluation-form__criterion mt-evaluation-form__criterion--implementation">
                <div class="mt-evaluation-form__criterion-header">
                    <span class="mt-evaluation-form__criterion-icon dashicons dashicons-hammer"></span>
            ...
            <div class="mt-evaluation-form__criterion mt-evaluation-form__criterion--relevance">
                <div class="mt-evaluation-form__criterion-header">
                    <span class="mt-evaluation-form__criterion-icon dashicons dashicons-location-alt"></span>
            ...
            <div class="mt-evaluation-form__criterion mt-evaluation-form__criterion--visibility">
                <div class="mt-evaluation-form__criterion-header">
                    <span class="mt-evaluation-form__criterion-icon dashicons dashicons-visibility"></span>
            ...
            <div class="mt-criteria-grid">
                ...
                ?>
                    <div class="mt-criterion-card" data-criterion="<?php echo esc_attr($key); ?>">
                        <div class="mt-evaluation-form__criterion-header mt-evaluation-form__criterion-header--<?php echo esc_attr($key); ?>">
                            <span class="mt-evaluation-form__criterion-icon dashicons <?php echo esc_attr($criterion['icon']); ?>"></span>
