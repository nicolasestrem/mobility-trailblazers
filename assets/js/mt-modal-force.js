...
(function() {
    ...
    function initModals() {
        console.log('MT Modal Force: Initializing modal system');
        ...
        if (autoAssignBtn) {
            autoAssignBtn.addEventListener('click', function(e) {
                e.preventDefault();
                e.stopPropagation();
                console.log('MT Modal Force: Auto-assign button clicked');
        ...
        if (manualAssignBtn) {
            manualAssignBtn.addEventListener('click', function(e) {
                e.preventDefault();
                e.stopPropagation();
                console.log('MT Modal Force: Manual assign button clicked');
    ...
    function showModal(modalId) {
        console.log('MT Modal Force: Showing modal', modalId);
        
        var modal = document.getElementById(modalId);
        if (!modal) {
            console.error('MT Modal Force: Modal not found', modalId);
            return;
        }
        ...
        console.log('MT Modal Force: Modal should be visible now');
    }
    
    function hideModal(modalId) {
        console.log('MT Modal Force: Hiding modal', modalId);
    ...
    if (typeof jQuery !== 'undefined') {
        jQuery(document).ready(function($) {
            console.log('MT Modal Force: jQuery binding active');
