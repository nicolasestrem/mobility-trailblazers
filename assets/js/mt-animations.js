...
(function($) {
    ...
    const MTAnimations = {
        ...
        initPerformanceMonitor: function() {
            ...
            if (animatedElements.length > 50) {
                console.warn('MT Animations: Large number of animated elements detected. Consider reducing for better performance.');
            }
            ...
            animatedElements.forEach(element => {
                ...
                element.addEventListener('animationend', (e) => {
                    if (element.dataset.animStart) {
                        ...
                        if (duration > 1000) {
                            console.warn(`MT Animations: Slow animation detected on element:`, element);
                        }
    ...
    $.fn.mtAnimate = function(method, ...args) {
        if (typeof method === 'string' && typeof MTAnimations[method] === 'function') {
            ...
            console.error(`MT Animations: Method ${method} not found`);
            return this;
        }
    };
