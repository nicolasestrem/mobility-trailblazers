...
startup_names = [
    ...
    "Dr. Anna Schmidt", "Carlos Mendoza", "Lisa Weber", "Dr. Hans Mueller", "Emma Johnson",
    "Dr. Klaus Fischer", "Maria Garcia", "Dr. Peter Wagner", "Sophie Martin", "Dr. Thomas Klein",
    "Isabella Silva", "Dr. Andreas Bauer", "Nina Mueller", "Dr. Stefan Wolf", "Anna Schmidt",
    "Dr. Michael Koenig", "Elena Petrova", "Dr. Hans Mueller", "Lisa Weber", "Dr. Klaus Fischer",
    "Maria Garcia", "Dr. Peter Wagner", "Sophie Martin", "Dr. Thomas Klein", "Isabella Silva",
    "Dr. Andreas Bauer", "Nina Mueller", "Dr. Stefan Wolf", "Anna Schmidt", "Dr. Michael Koenig"
]
...
gov_names = [
    ...
    "Dr. Hans Mueller", "Lisa Weber", "Dr. Klaus Fischer", "Maria Garcia", "Dr. Peter Wagner",
    "Sophie Martin", "Dr. Thomas Klein", "Isabella Silva", "Dr. Andreas Bauer", "Nina Mueller",
    "Dr. Stefan Wolf", "Anna Schmidt", "Dr. Michael Koenig", "Elena Petrova", "Dr. Hans Mueller",
    "Lisa Weber", "Dr. Klaus Fischer", "Maria Garcia", "Dr. Peter Wagner", "Sophie Martin",
    "Dr. Thomas Klein", "Isabella Silva", "Dr. Andreas Bauer", "Nina Mueller", "Dr. Stefan Wolf",
    "Anna Schmidt", "Dr. Michael Koenig", "Elena Petrova", "Dr. Hans Mueller", "Lisa Weber"
]
...
def generate_147_candidates():
    """Generate 147 additional candidates"""
    candidates = []
    
    # Split evenly across categories (49 Startup, 49 Gov, 49 Tech)
    categories = ['Startup'] * 49 + ['Gov'] * 49 + ['Tech'] * 49
    random.shuffle(categories)
    
    # Create copies of name lists to avoid modifying originals
    startup_names_copy = startup_names.copy()
    gov_names_copy = gov_names.copy()
    tech_names_copy = tech_names.copy()
    
    for i, category in enumerate(categories, start=4):  # Start from ID 4
        if category == 'Startup':
            name = random.choice(startup_names_copy)
            startup_names_copy.remove(name)  # Remove to avoid duplicates
            org = random.choice(startup_orgs)
            position = random.choice(positions_startup)
        elif category == 'Gov':
            name = random.choice(gov_names_copy)
            gov_names_copy.remove(name)  # Remove to avoid duplicates
            org = random.choice(gov_orgs)
            position = random.choice(positions_gov)
        else:  # Tech
            name = random.choice(tech_names_copy)
            tech_names_copy.remove(name)  # Remove to avoid duplicates
...
def create_csv_file(filename="test-candidates.csv"):
    """Create the CSV file with original + 147 new candidates"""
    all_candidates = original_candidates + generate_147_candidates()
